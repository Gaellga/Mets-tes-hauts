    ...
    <form @submit.prevent="getWeather()">
      ...
      <div class="row border-green">
        <div class="offset-md-2 col-md-8 border">
          ...
          <div class="row border-green">
            <div class="offset-md-1 col-md-2 border"><p></p><p>{{tomorrowTemp}}</p></div>
            <div class="col-md-2 border"><p>blabla</p></div>
            <div class="col-md-2 border"><p>blabla</p></div>
            <div class="col-md-2 border"><p>blabla</p></div>
            <div class="col-md-2 border"><p>blabla</p></div>
          </div>
...
export default {
  ...
  methods:{
    ...
    getWeather(){
      axios
        ...
        .then(response => {
          ...
          this.icon = "./assets/img/" + this.resp.weather[0].icon.slice(0,2) + "d.png";
    ...
    <style>
    .border-green{
        border: 5px solid rgb(126, 218, 126);
    }
    </style>
