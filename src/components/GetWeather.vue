  ...
  <form @submit.prevent="getWeather()">
    <div class="row">
      <div class="offset-md-3 col-md-6">
        <div class="form-group">
          <input v-model="inputdata" type="text" class="form-control" aria-describedby="browsecity"
    ...
    <div class="row border-green">
      <div class="offset-md-2 col-md-8 border">
        <div class="row">
          <div class="col-md-12 border">
            <div class="row">
              ...
              <div class="col-md-4">
                <p id="pression">Pression atmosphérique : {{pressure}} pa</p>Humidité : {{humidity}}<p></p>Vent :
                {{wind}}<p></p>
              </div>
            </div>
          </div>
        ...
        <div class="row border-green">
          <div class="col-md-3 border"><img class="iconeNext" v-bind:src="icon2" alt="weather icon day 2">
            <p>{{jour1}}</p>
            <p>{{tomorrowTemp}}</p>
          </div>
          <div class="col-md-3 border"><img class="iconeNext" v-bind:src="icon3" alt="weather icon day 3">
            <p>{{jour2}}</p>
            <p>{{dayThree}}</p>
          </div>
          <div class="col-md-3 border"><img class="iconeNext" v-bind:src="icon4" alt="weather icon day 4">
            <p>{{jour3}}</p>
            <p>{{dayFour}}</p>
          </div>
          <div class="col-md-3 border"><img class="iconeNext" v-bind:src="icon5" alt="weather icon day 5">
            <p>{{jour4}}</p>
            <p>{{dayFive}}</p>
          </div>
        </div>
